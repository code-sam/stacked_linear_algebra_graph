...
pub(crate) fn select_edges_with_tail_vertex<EvaluationDomain>(
    ...
    EvaluationDomain: ValueType,
{
    ...
    vertex_store.try_vertex_index_validity(tail_vertex)?;
...
pub(crate) fn select_edges_with_tail_vertex_unchecked<EvaluationDomain>(
