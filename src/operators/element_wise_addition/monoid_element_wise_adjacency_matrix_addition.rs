...
macro_rules! implement_element_wise_adjacency_matrix_addition {
    ($evaluation_domain: ty) => {
        impl<
                ...
                Product: ValueType + SparseAdjacencyMatrixForValueType<Product>,
            >
            MonoidElementWiseAdjacencyMatrixAddition<
                LeftArgument,
                RightArgument,
                Product,
                $evaluation_domain,
...
macro_rules! implement_element_wise_masked_adjacency_matrix_addition {
    ($evaluation_domain: ty) => {
        impl<
                LeftArgument: ValueType + SparseAdjacencyMatrixForValueType<LeftArgument>,
                RightArgument: ValueType + SparseAdjacencyMatrixForValueType<RightArgument>,
...
implement_macro_for_all_native_value_types!(
    implement_element_wise_masked_adjacency_matrix_addition
);
