...
//     }, graphblas_bindings::{GrB_Matrix, GrB_Vector}
// };
// use graphblas_sparse_linear_algebra::context::Context as GraphblasContext;

// use crate::{
//     error::GraphComputingError,
//     graph::{value_type::{ValueType, ValueTypeIdentifier}, weighted_adjacency_matrix::WeightedAdjacencyMatrix},
...
// pub(crate) struct WeightedAdjacencyMatrixMatrixStateReverter {
//     size_to_restore: Size,
//     state_to_restore: Vec<WeightedAdjacencyMatrixStateToRestore>,
// }

// impl GetSparseMatrixSizeToRestore for WeightedAdjacencyMatrixMatrixStateReverter {
//     fn matrix_size_to_restore_ref(&self) -> &Size {
//         &self.size_to_restore
//     }
// }

// pub(crate) enum WeightedAdjacencyMatrixStateToRestore {
//     Collecting(WeightedtedAdjacencyMatrixElementsToRestore),
//     FullyDetermined(FullyDeterminedWeightedAdjacencyMatrixStateToRestore)
// }

// pub(crate) struct WeightedtedAdjacencyMatrixElementsToRestore {
//     graphblas_context: Arc<GraphblasContext>,
//     edge_weight_value_type: ValueTypeIdentifier, // TODO: is this identifier required?
//     row_indices_edge_weights_to_restore: Vec<RowIndex>,
//     column_indices_edge_weights_to_restore: Vec<ColumnIndex>,
//     edge_weights_to_restore: GrB_Vector,
// }

// impl WeightedtedAdjacencyMatrixElementsToRestore {
//     fn new(
//         edge_weight_value_type: ValueTypeIdentifier,
//         graphblas_context: &Arc<GraphblasContext>
//     ) -> Self {
//         let row_indices_edge_weights_to_restore = Vec::new();
//         let column_indices_edge_weights_to_restore = Vec::new();
//         let
//     }
// }

// pub(crate) struct FullyDeterminedWeightedAdjacencyMatrixStateToRestore {
//     element_state_to_restore: WeightedtedAdjacencyMatrixElementsToRestore,
//     adjacency_matrix_to_restore: GrB_Matrix
// }

// impl FullyDeterminedWeightedAdjacencyMatrixStateToRestore {
//     fn new(element_state_to_restore: WeightedtedAdjacencyMatrixElementsToRestore, adjacency_matrix_to_restore: GrB_Matrix) -> Self {
//         Self {
//             element_state_to_restore,
...
// impl<T> RegisterWeightedAdjacencyMatrixChangeToRevert<T> for WeightedAdjacencyMatrixMatrixStateReverter
// where
...
// impl RestoreState<WeightedAdjacencyMatrix>
//     for WeightedAdjacencyMatrixMatrixStateReverter
// {
//     fn restore(
//         self,
