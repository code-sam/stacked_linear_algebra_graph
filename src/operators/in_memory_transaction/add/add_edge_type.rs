...
use crate::operators::in_memory_transaction::transaction::AtomicInMemoryTransaction;
use crate::operators::operators::add::AddEdgeType;
use crate::operators::operators::add::AddPrivateEdgeType;

impl<'t, T: ValueType + GetValueTypeIdentifier> AddEdgeType<T> for AtomicInMemoryTransaction<'t> {
