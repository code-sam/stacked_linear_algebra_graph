...
pub trait MonoidElementWiseMaskedAdjacencyMatrixMultiplication<EvaluationDomain>
where
    EvaluationDomain: ValueType,
{
    fn by_index(
...
impl<EvaluationDomain: ValueType>
    MonoidElementWiseMaskedAdjacencyMatrixMultiplication<EvaluationDomain> for Graph
{
    fn by_index(
        &mut self,
        left_argument: &EdgeTypeIndex,
...
mod tests {
    ...
    fn monoid_element_wise_adjacency_matrix_multiplication() {
        ...
        for _i in 0..2 {
            MonoidElementWiseAdjacencyMatrixMultiplication::<u8>::by_key(
                &mut graph,
                &edge_type_1_key,
                &Plus::<u8>::new(),
                &edge_type_1_key,
