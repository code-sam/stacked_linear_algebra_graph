...
macro_rules! implement_element_wise_vertex_vector_multiplication {
...
implement_macro_for_all_native_value_types!(implement_element_wise_vertex_vector_multiplication);
...
macro_rules! implement_element_wise_masked_vertex_vector_multiplication {
    ($evaluation_domain: ty) => {
        impl<
                LeftArgument: ValueType + SparseVertexVectorForValueType<LeftArgument>,
                RightArgument: ValueType + SparseVertexVectorForValueType<RightArgument>,
...
implement_macro_for_all_native_value_types!(
    implement_element_wise_masked_vertex_vector_multiplication
);
