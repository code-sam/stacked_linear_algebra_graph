...
pub(crate) trait SemiringElementWiseAdjacencyMatrixMultiplicationUnchecked<EvaluationDomain>
where
    EvaluationDomain: ValueType,
{
    fn apply(
    ...
    for Graph
{
    fn apply(
        ...
        SemiringElementWiseAdjacencyMatrixMultiplicationUnchecked::apply(
            self,
            left_argument,
            operator,
            right_argument,
