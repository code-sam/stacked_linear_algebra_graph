...
pub(crate) fn apply_monoid_element_wise_vertex_vector_multiplication<EvaluationDomain>(
...
pub(crate) fn apply_monoid_element_wise_vertex_vector_multiplication_unchecked<EvaluationDomain>(
