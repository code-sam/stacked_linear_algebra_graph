...
use crate::graph_operators::in_memory::element_wise_addition::apply_monoid_element_wise_adjacency_matrix_addition;
use crate::graph_operators::in_memory::element_wise_addition::apply_monoid_element_wise_adjacency_matrix_addition_unchecked;
use crate::graph_operators::operator_traits::element_wise_addition::MonoidElementWiseAdjacencyMatrixAddition;
use crate::graph_operators::operator_traits::element_wise_addition::MonoidElementWiseAdjacencyMatrixAdditionUnchecked;
...
impl<'g, EvaluationDomain: ValueType> MonoidElementWiseAdjacencyMatrixAddition<EvaluationDomain>
    for InMemoryGraphTransaction<'g>
{
    fn apply(
        ...
        apply_monoid_element_wise_adjacency_matrix_addition::<EvaluationDomain>(
...
impl<'g, EvaluationDomain: ValueType>
    MonoidElementWiseAdjacencyMatrixAdditionUnchecked<EvaluationDomain>
    for InMemoryGraphTransaction<'g>
{
    fn apply(
        &mut self,
        ...
        apply_monoid_element_wise_adjacency_matrix_addition_unchecked::<EvaluationDomain>(
            &mut self.edge_store_transaction,
            left_argument,
            operator,
            right_argument,
...
mod tests {
    ...
    fn monoid_element_wise_adjacency_matrix_addition() {
        ...
        for _i in 0..2 {
            MonoidElementWiseAdjacencyMatrixAddition::<u8>::apply(
                &mut graph,
                &edge_type_1_index,
                &Plus::<u8>::new(),
                &edge_type_1_index,
