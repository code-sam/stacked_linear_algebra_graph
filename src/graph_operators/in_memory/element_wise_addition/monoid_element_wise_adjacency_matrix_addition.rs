...
impl<EvaluationDomain: ValueType>
    MonoidElementWiseAdjacencyMatrixAdditionUnchecked<EvaluationDomain> for Graph
{
    fn apply(
        &mut self,
        left_argument: &impl GetEdgeTypeIndex,
...
pub(crate) fn apply_monoid_element_wise_adjacency_matrix_addition<EvaluationDomain>(
...
pub(crate) fn apply_monoid_element_wise_adjacency_matrix_addition_unchecked<EvaluationDomain>(
