...
pub(crate) fn apply_semiring_element_wise_vertex_vector_addition<EvaluationDomain>(
...
pub(crate) fn apply_semiring_element_wise_vertex_vector_addition_unchecked<EvaluationDomain>(
