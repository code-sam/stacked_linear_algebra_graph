...
use crate::graph_operators::operator_traits::element_wise_addition::SemiringElementWiseAdjacencyMatrixAddition;
use crate::graph_operators::operator_traits::element_wise_addition::SemiringElementWiseAdjacencyMatrixAdditionUnchecked;
...
impl<EvaluationDomain: ValueType>
    SemiringElementWiseAdjacencyMatrixAdditionUnchecked<EvaluationDomain> for Graph
{
    fn apply(
        &mut self,
        left_argument: &impl GetEdgeTypeIndex,
...
pub(crate) fn apply_semiring_element_wise_adjacency_matrix_addition<EvaluationDomain>(
...
pub(crate) fn apply_semiring_element_wise_adjacency_matrix_addition_unchecked<EvaluationDomain>(
