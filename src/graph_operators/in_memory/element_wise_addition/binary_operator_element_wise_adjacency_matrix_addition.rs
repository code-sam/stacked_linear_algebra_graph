    ...
    for Graph
{
    fn apply(
        ...
        apply_binary_operator_element_wise_adjacency_matrix_addition::<EvaluationDomain>(
    ...
    BinaryOperatorElementWiseAdjacencyMatrixAdditionUnchecked<EvaluationDomain> for Graph
{
    fn apply(
        ...
        apply_binary_operator_element_wise_adjacency_matrix_addition_unchecked::<EvaluationDomain>(
            &mut self.public_edge_store,
            left_argument,
            operator,
            right_argument,
...
pub(crate) fn apply_binary_operator_element_wise_adjacency_matrix_addition<EvaluationDomain>(
...
pub(crate) fn apply_binary_operator_element_wise_adjacency_matrix_addition_unchecked<
    EvaluationDomain,
>(
...
mod tests {
    ...
    fn binary_operator_element_wise_adjacency_matrix_addition() {
        ...
        assert_eq!(
            GetEdgeWeight::<u8>::edge_weight_for_coordinate(
                &graph,
