...
use crate::graph_operators::operator_traits::element_wise_multiplication::{BinaryOperatorElementWiseAdjacencyMatrixMultiplication, BinaryOperatorElementWiseAdjacencyMatrixMultiplicationUnchecked};
use crate::operator_options::OptionsForOperatorWithAdjacencyMatrixArguments;
use crate::{error::GraphComputingError, graph::value_type::ValueType};

impl<EvaluationDomain: ValueType>
    BinaryOperatorElementWiseAdjacencyMatrixMultiplication<EvaluationDomain> for Graph
{
    fn apply(
        &mut self,
...
impl<EvaluationDomain: ValueType>
    BinaryOperatorElementWiseAdjacencyMatrixMultiplicationUnchecked<EvaluationDomain> for Graph
{
    fn apply(
        &mut self,
        left_argument: &impl GetEdgeTypeIndex,
...
pub(crate) fn apply_binary_operator_element_wise_adjacency_matrix_multiplication<EvaluationDomain>(
    ...
    EvaluationDomain: ValueType,
{
    ...
    apply_binary_operator_element_wise_adjacency_matrix_multiplication_unchecked::<EvaluationDomain>(
        edge_store,
        left_argument,
        operator,
        right_argument,
...
pub(crate) fn apply_binary_operator_element_wise_adjacency_matrix_multiplication_unchecked<
    EvaluationDomain,
>(
