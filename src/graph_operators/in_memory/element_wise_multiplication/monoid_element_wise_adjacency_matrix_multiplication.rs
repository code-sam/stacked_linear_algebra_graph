...
pub(crate) fn apply_monoid_element_wise_adjacency_matrix_multiplication<EvaluationDomain>(
...
pub(crate) fn apply_monoid_element_wise_adjacency_matrix_multiplication_unchecked<
    EvaluationDomain,
>(
