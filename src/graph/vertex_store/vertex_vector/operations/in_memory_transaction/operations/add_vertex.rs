...
use crate::graph::vertex_store::operations::CheckVertexIndex;
use crate::graph::vertex_store::operations::CheckVertexTypeIndex;
...
mod tests {
    ...
    use crate::graph::vertex_store::{
        operations::AddPublicVertexType, GetVertexValue, VertexStore,
    };
