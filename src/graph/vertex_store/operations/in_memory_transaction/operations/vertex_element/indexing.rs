...
impl<'s> CheckVertexIndex for AtomicInMemoryVertexStoreTransaction<'s> {
    ...
    fn try_vertex_index_validity(
        ...
        self.vertex_store_ref().try_vertex_index_validity(vertex_index)
    }
    ...
    fn is_valid_private_vertex_index(
        ...
        self.vertex_store_ref().is_valid_private_vertex_index(vertex_index)
    }
    ...
    fn try_is_valid_private_vertex_index(
        ...
        self.vertex_store_ref().try_is_valid_private_vertex_index(vertex_index)
    }
}