...
use crate::graph::vertex_store::traits::in_memory_transaction::transaction::vertex_store_state_restorer::vertex_vectors_state_restorer::RegisterVertexVectorCapacityToRestore;
