...
use crate::graph::vertex_store::traits::in_memory_transaction::transaction::{InMemoryVertexStoreTransaction, VertexStoreStateRestorer};
...
use crate::graph::vertex_store::traits::in_memory_transaction::transaction::vertex_store_state_restorer::vertex_vectors_state_restorer::RegisterTypedVertexVectorToRestore;
...
impl VertexStoreStateRestorer {
    fn register_deleted_vertex_vector_to_restore(
        ...
        Ok(match vertex_vector.value_type_identifier_ref() {
            ValueTypeIdentifier::Bool => {
