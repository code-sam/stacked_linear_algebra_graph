...
pub(crate) struct InMemoryVertexStoreTransaction<'s> {
    pub(in crate::graph::vertex_store::traits::in_memory_transaction) vertex_store:
        &'s mut VertexStore,
    pub(in crate::graph::vertex_store::traits::in_memory_transaction) vertex_store_state_restorer:
