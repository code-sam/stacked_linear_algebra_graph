...
static GRAPHBLAS_ANY_OPERATOR_IN_HORIZONTAL_DIRECTION: Lazy<MonoidReducer<bool, bool>> =
    Lazy::new(|| {
...
static GRAPHBLAS_ANY_OPERATOR_IN_VERTICAL_DIRECTION: Lazy<MonoidReducer<bool, bool>> =
    Lazy::new(|| {
        MonoidReducer::<bool, bool>::new(
            &Any::<bool>::new(),
...
impl AdjacencyMatrix {
    ...
    pub(crate) fn edge_type_ref(&self) -> &EdgeTypeKeyRef {
