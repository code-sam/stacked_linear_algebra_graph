...
use crate::graph::weighted_adjacency_matrix::traits::SetEdge as AddEdgeToAdjacencyMatrix;

impl<T> UpdateEdge<T> for EdgeStore
where
    T: ValueType + Copy + SetSparseMatrixElementTyped<T>,
{
    ...
    fn update_edge(
        ...
        self.try_is_edge(edge_type_index, tail, head)?;
