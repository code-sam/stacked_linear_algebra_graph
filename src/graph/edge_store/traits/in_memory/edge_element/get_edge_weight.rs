...
use crate::graph::edge_store::traits::traits::edge_element::{GetEdgeWeight, Indexing};
...
use crate::graph::weighted_adjacency_matrix::traits::GetEdgeWeight as GetEdgeWeightFromAdjacencyMatrix;
    ...
    usize: IntoValueType<T>,
{
    fn edge_weight(
        &self,
        vertex_indexer: &impl crate::graph::vertex_store::traits::vertex_element::CheckVertexIndex,
