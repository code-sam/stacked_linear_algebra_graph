...
pub(crate) struct InMemoryEdgeStoreTransaction<'s> {
    pub(in crate::graph::edge_store::traits::in_memory_transaction) edge_store:
        &'s mut EdgeStore,
    pub(in crate::graph::edge_store::traits::in_memory_transaction) edge_store_state_restorer:
