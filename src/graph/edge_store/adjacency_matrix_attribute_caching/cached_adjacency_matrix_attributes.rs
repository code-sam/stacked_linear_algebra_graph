...
impl CachedAdjacencyMatrixAttributes {
    pub(crate) fn new() -> Self {
        CachedAdjacencyMatrixAttributes { transpose: None }
    }
}
...
impl CachedAdjacencyMatrixAttributes {
    fn compute_transpose(
        ...
        let transpose = match adjacency_matrix.value_type_identifier_ref() {
            &ValueTypeIdentifier::Bool => transpose_adjacency_matrix_bool(adjacency_matrix)?,
            &ValueTypeIdentifier::Int8 => transpose_adjacency_matrix_i8(adjacency_matrix)?,
            &ValueTypeIdentifier::Int16 => transpose_adjacency_matrix_i16(adjacency_matrix)?,
            &ValueTypeIdentifier::Int32 => transpose_adjacency_matrix_i32(adjacency_matrix)?,
            &ValueTypeIdentifier::Int64 => transpose_adjacency_matrix_i64(adjacency_matrix)?,
            &ValueTypeIdentifier::UInt8 => transpose_adjacency_matrix_u8(adjacency_matrix)?,
            &ValueTypeIdentifier::UInt16 => transpose_adjacency_matrix_u16(adjacency_matrix)?,
            &ValueTypeIdentifier::UInt32 => transpose_adjacency_matrix_u32(adjacency_matrix)?,
            &ValueTypeIdentifier::UInt64 => transpose_adjacency_matrix_u64(adjacency_matrix)?,
            &ValueTypeIdentifier::Float32 => transpose_adjacency_matrix_f32(adjacency_matrix)?,
            &ValueTypeIdentifier::Float64 => transpose_adjacency_matrix_f64(adjacency_matrix)?,
            &ValueTypeIdentifier::ISize => transpose_adjacency_matrix_isize(adjacency_matrix)?,
            &ValueTypeIdentifier::USize => transpose_adjacency_matrix_usize(adjacency_matrix)?,
        };
