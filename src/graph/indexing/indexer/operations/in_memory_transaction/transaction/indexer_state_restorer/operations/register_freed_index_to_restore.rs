...
pub(crate) trait RegisterFreedIndexToRestore {
    fn register_freed_public_index_to_restore(
        &mut self,
        index: Index,
    ) -> Result<(), GraphComputingError>;
    fn register_freed_private_index_to_restore(
        &mut self,
        index: Index,
    ) -> Result<(), GraphComputingError>;
}
...
impl RegisterFreedIndexToRestore for IndexerStateRestorer {
    fn register_freed_public_index_to_restore(
        ...
        self.mask_with_valid_public_indices_restorer_mut_ref()
            .register_element_value_to_restore(index, true);
        Ok(())
    }
    ...
    fn register_freed_private_index_to_restore(
        ...
        self.mask_with_valid_indices_restorer_mut_ref()
            .register_element_value_to_restore(index, true);
        self.mask_with_private_indices_restorer_mut_ref()
            .register_element_value_to_restore(index, true);
        self.mask_with_valid_private_indices_restorer_mut_ref()
            .register_element_value_to_restore(index, true);
        Ok(())
    }
}
