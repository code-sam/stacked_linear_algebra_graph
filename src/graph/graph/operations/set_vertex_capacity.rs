...
impl SetVertexCapacity for Graph {
    fn set_vertex_capacity(
        ...
        self.vertex_store_mut_ref().element_indexer_mut_ref().set_index_capacity(vertex_capacity)?;
        self.edge_store_mut_ref().edge_type_indexer_mut_ref().set_index_capacity(vertex_capacity)?;
        Ok(())
    }
