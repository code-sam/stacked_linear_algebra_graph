...
trait NativeDataType: ValueType + BuiltInValueType {}

pub(crate) trait IndexedNumericalValueStoreTrait {}

pub(crate) struct IndexedNumericalValueStore {}

impl IndexedNumericalValueStore {
    fn new(graphblas_context: Arc<GraphBLASContext>) -> Result<Self, GraphComputingError> {}
